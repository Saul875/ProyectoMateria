...
const styles = StyleSheet.create({
  ...
  actionBar: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#FFF', marginHorizontal: 20, padding: 15, borderRadius: 20, marginBottom: 20, elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 8 },
  countNumber: { fontSize: 20, fontWeight: 'bold', color: '#5B3E31' },
  countText: { fontSize: 12, color: '#9E8A7D' },
  btnsRow: { flexDirection: 'row' },
  btnAdd: { flexDirection: 'row', backgroundColor: '#28A745', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 15, alignItems: 'center', marginRight: 10 },
  btnRequest: { flexDirection: 'row', backgroundColor: '#3B82F6', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 15, alignItems: 'center' },
  btnText: { color: '#FFF', fontWeight: 'bold', fontSize: 12, marginLeft: 4 },
  tableCard: { backgroundColor: '#FFF', borderRadius: 20, overflow: 'hidden', elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 8 },
  tableHeader: { flexDirection: 'row', backgroundColor: '#785A46', paddingVertical: 12, paddingHorizontal: 15 },
  th: { color: '#FFF', fontWeight: 'bold', fontSize: 14, flex: 1 },
  tableRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 15, paddingHorizontal: 15 },
  tdTitle: { color: '#5B3E31', fontWeight: 'bold', fontSize: 14 },
  tdQty: { flex: 1, color: '#5B3E31', fontWeight: 'bold', fontSize: 16 },
  tdUnit: { flex: 1, color: '#9E8A7D', fontSize: 12 },
  tdActions: { flex: 1, flexDirection: 'row', justifyContent: 'flex-end' },
  iconBtn: { width: 28, height: 28, borderRadius: 8, justifyContent: 'center', alignItems: 'center', marginLeft: 6 },
  divider: { height: 1, backgroundColor: '#F3F4F6', marginHorizontal: 15 },
  modalOverlayFull: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' },
  modalContentFull: { backgroundColor: '#F9F3EA', borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 20, paddingBottom: 40 },
  cardSolicitud: { backgroundColor: '#FFF', borderRadius: 15, padding: 20, marginBottom: 25, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 5 },
  ...
  modalExitoCard: { backgroundColor: '#FFF', borderRadius: 25, padding: 30, width: '80%', alignItems: 'center', elevation: 5 },
  modalTitleExito: { fontSize: 22, fontWeight: 'bold', color: '#5B3E31', marginBottom: 10, textAlign: 'center' },
  modalSubExito: { fontSize: 14, color: '#9E8A7D', marginBottom: 25, textAlign: 'center', lineHeight: 20 },
  btnOk: { backgroundColor: '#28A745', paddingVertical: 14, paddingHorizontal: 40, borderRadius: 15, width: '100%', alignItems: 'center' },
  btnOkText: { color: '#FFF', fontSize: 16, fontWeight: 'bold' },
});
