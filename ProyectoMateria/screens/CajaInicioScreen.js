...
const styles = StyleSheet.create({
  ...
  tabsMenu: { flexDirection: 'row', paddingHorizontal: 20, marginBottom: 20, justifyContent: 'space-between' },
  tabItemActive: { flex: 1, alignItems: 'center', paddingBottom: 8 },
  tabItem: { flex: 1, alignItems: 'center', paddingBottom: 8 },
  tabTextActive: { fontSize: 16, fontWeight: 'bold', color: '#5B3E31' },
  tabText: { fontSize: 16, fontWeight: '500', color: '#9E8A7D' },
  tabIndicator: { height: 3, backgroundColor: '#5B3E31', width: 20, marginTop: 4, borderRadius: 2 },
  grid: { paddingHorizontal: 20, paddingBottom: 120 },
  row: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 15 },
  card: { width: '48%', backgroundColor: '#FFF', borderRadius: 25, padding: 20, alignItems: 'center', elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 8 },
  circleIcon: { width: 60, height: 60, borderRadius: 30, justifyContent: 'center', alignItems: 'center', marginBottom: 15 },
  cardLabel: { fontSize: 14, color: '#9E8A7D', marginBottom: 8 },
  cardValue: { fontSize: 18, fontWeight: 'bold', color: '#5B3E31' },
  cardValueText: { fontSize: 16, fontWeight: 'bold', color: '#5B3E31' },
});
